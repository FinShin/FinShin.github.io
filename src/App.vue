...
const certificates = ref([
  {
    ...
    description:
      "Completed the competency requirements under the Philippine TVET Competency Assessment and Certification System for the CSS NCII",
  },
  {
    image: CODECHUM,
    title: "CodeChum Achievement",
    description:
      "4th place in Group Stage 1 of the CodeChum National Programming Challenge 2025, held on November 13, 2025.",
  },
  {
    image: ITE,
